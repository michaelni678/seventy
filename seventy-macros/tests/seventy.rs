...
/// NOTE: This test is closely related to
/// `upgrades::independent::sanitizer_construction_count`.
#[test]
...
/// NOTE: This test is closely related to
/// `upgrades::independent::validator_construction_count`.
#[test]
